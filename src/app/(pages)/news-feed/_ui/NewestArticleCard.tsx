...
interface NewestArticleCardProps {
  article: Article
}

export function NewestArticleCard({ article }: NewestArticleCardProps) {
  return (
    <div className="bg-white shadow-[rgba(0,0,0,0)_0px_0px_0px_0px,rgba(0,0,0,0)_0px_0px_0px_0px,rgba(0,0,0,0)_0px_0px_0px_0px,rgba(0,0,0,0)_0px_0px_0px_0px,rgba(0,0,0,0.05)_0px_1px_2px_0px] box-border min-w-64 outline-[oklab(0.136266_-0.00681703_-0.0357494_/_0.5)] w-full border border-slate-200 rounded-lg border-solid md:min-w-0 md:w-auto">
      <div className="box-border gap-x-3 flex basis-full flex-col outline-[oklab(0.136266_-0.00681703_-0.0357494_/_0.5)] gap-y-3 p-3">
        <div className="items-center box-border gap-x-1 flex justify-between outline-[oklab(0.136266_-0.00681703_-0.0357494_/_0.5)] gap-y-1 mb-2">
          <div className="shadow-[rgba(0,0,0,0)_0px_0px_0px_0px,rgba(0,0,0,0)_0px_0px_0px_0px,rgba(0,0,0,0)_0px_0px_0px_0px,rgba(0,0,0,0)_0px_0px_0px_0px,rgba(0,0,0,0)_0px_0px_0px_0px] box-border outline-[oklab(0.136266_-0.00681703_-0.0357494_/_0.5)] p-0.5 rounded-sm">
          ...
          <p className="text-[9px] box-border leading-[12.6px] outline-[oklab(0.136266_-0.00681703_-0.0357494_/_0.5)] text-right font-lexend">
            {article.date}
          </p>
        </div>
        <div className="box-border flex justify-center outline-[oklab(0.136266_-0.00681703_-0.0357494_/_0.5)] w-full border-2 border-solid border-transparent">
